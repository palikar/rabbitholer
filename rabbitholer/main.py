...
def get_arg_parser():
    ...
    settings_parser.add_argument('--routing', '-r', action='store', metavar='Routing key',
                                default='', required=False, dest='routing_key',
                                help='The routing key of the message')

    settings_parser.add_argument('--queue', '-q', action='store', metavar='Queue',
                                 default='general', required=False, dest='queue',
                                 help='Queue to bind to the exchange')

    settings_parser.add_argument('--server', '-s', action='store', metavar='Server',
                                 default='taygeta', required=False, dest='server',
                                help='The server where the RabbiMQ server is running')
